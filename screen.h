...
class Screen {
   ...
   * has the same size of the screen. It then paints each pixel in an unique
   * color or not, according to the contents of the pixels array.
   *
   * @param dst a array of bytes mapping the screen-texture. Its size must be
   ...
   * 0 or 1. Its size must be the width times the height of the screen.
   ...
   */
  int updatePixels(GLubyte *dst, char *pixels, uint drawColor, uint bgColor,
